...
public final class HasDownloadedImageCondition implements Condition, AttachableFile {

    private static final String RESOURCE_PATH = "testdata/uploadedFile.jpeg";
