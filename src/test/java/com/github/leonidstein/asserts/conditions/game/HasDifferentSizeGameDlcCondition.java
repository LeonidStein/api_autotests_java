...
public final class HasDifferentSizeGameDlcCondition implements Condition {
    ...
    public void check(final ValidatableResponse response) {
        ...
        assertThat(dlc.size()).as("Проверка размерности массива dlcs после добавления нового dlc")
